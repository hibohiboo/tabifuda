...
(経緯は docs/tasks/projects/phase1/plans/p1-c1-review-decisions.md)。L3(IDスマート
...
(docs/tasks/projects/phase1/plans/p1-c1-review-decisions.md)参照。
...
**進捗の正は docs/tasks/projects/phase1/plans/p1-c1-review-decisions.md**(状態表・決定内容・
