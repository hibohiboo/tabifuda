...
| [P3 WASM+Web版(ローカル)](tasks/projects/phase3/task.md) | バックエンドなしのローカル Web アプリで遊べ、冒険記タイムライン UI を見られる | ブラウザ通しプレイ可 / タイムライン UI / 生 HTML 挿入の静的検査が CI に | 進行中(C0〜C2 完了。apps/web でシナリオ読込→カード進行の通しプレイ可) |
