...
| [P3 WASM+Web版(ローカル)](tasks/projects/phase3/task.md) | バックエンドなしのローカル Web アプリで遊べ、冒険記タイムライン UI を見られる | ブラウザ通しプレイ可 / タイムライン UI / 生 HTML 挿入の静的検査が CI に | 進行中(C0/C1 完了。wasm 境界 API 設計レビュー実施済み) |
